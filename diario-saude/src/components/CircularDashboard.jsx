...
export default function CircularDashboard({ agua = 1200, refeicoes = 3 }) {
  ...
  useEffect(() => {
    ...
    // Verificar marcador ativo (10, 25, 50, 75, 100)
    const markers = [10, 25, 50, 75, 100]
    let closestMarker = markers[0]
    let minDiff = Math.abs(markers[0] - novoTotal)
      ...
      <div className="circular-card">
        ...
        <div className="moto-gauge">
                    ...
                    return (
                      <text
                        ...
                        style={{
                          fontSize: '32px',
                          fontWeight: 'bold',
                          fill: activeMarker ? '#00ff88' : '#00ff88',
          ...
          <div style={{
            ...
            {markers.map(marker => {
              ...
              const radius = 88 // posição do marcador
        ...
        <div className="total-display">
          ...
          <div 
            ...
            style={{
              color: activeMarker ? '#00ff88' : '#00ff88',
